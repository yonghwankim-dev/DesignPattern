package chapter05_스트래티지패턴.ch05_04;

import chapter05_스트래티지패턴.ch05_04.strategy.BookDiscountPricePolicy;
import chapter05_스트래티지패턴.ch05_04.strategy.MemberDiscountPricePolicy;
import chapter05_스트래티지패턴.ch05_04.strategy.OrdinaryPricePolicy;
/**
